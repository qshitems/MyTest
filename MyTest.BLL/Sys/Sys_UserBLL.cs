...
namespace MyTest.BLL
{
	...
	{
		private readonly MyTest.DAL.Sys_UserDAL dal=new MyTest.DAL.Sys_UserDAL();
		public Sys_UserBLL()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public MyTest.Model.Sys_UserModel GetModelByCache(string F_Id)
		{
			
			string CacheKey = "Sys_UserModelModel-" + F_Id;
			...
			return (MyTest.Model.Sys_UserModel)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<MyTest.Model.Sys_UserModel> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MyTest.Model.Sys_UserModel> DataTableToList(DataTable dt)
		{
			List<MyTest.Model.Sys_UserModel> modelList = new List<MyTest.Model.Sys_UserModel>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MyTest.Model.Sys_UserModel model;
        ...
        {
            return  dal.GetPageList(Pagination,  Account);
        }
