...
namespace MyTest.DAL
{
	...
	public partial class Sys_ModuleDAL
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(MyTest.Model.Sys_ModuleModel model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Sys_Module(");
			strSql.Append("F_Id,F_ParentId,F_Layers,F_EnCode,F_FullName,F_Icon,F_UrlAddress,F_Target,F_IsMenu,F_IsExpand,F_IsPublic,F_AllowEdit,F_AllowDelete,F_SortCode,F_DeleteMark,F_EnabledMark,F_Description,F_CreatorTime,F_CreatorUserId,F_LastModifyTime,F_LastModifyUserId,F_DeleteTime,F_DeleteUserId)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@F_IsMenu", SqlDbType.Bit,1),
					new SqlParameter("@F_IsExpand", SqlDbType.Bit,1),
			...
			parameters[6].Value = model.F_UrlAddress;
			parameters[7].Value = model.F_Target;
			parameters[8].Value = model.F_IsMenu;
			parameters[9].Value = model.F_IsExpand;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(MyTest.Model.Sys_ModuleModel model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append("F_IsExpand=@F_IsExpand,");
			...
			parameters[4].Value = model.F_Icon;
			parameters[5].Value = model.F_UrlAddress;
			parameters[6].Value = model.F_Target;
			parameters[7].Value = model.F_IsMenu;
			parameters[8].Value = model.F_IsExpand;
			parameters[9].Value = model.F_IsPublic;
			parameters[10].Value = model.F_AllowEdit;
			parameters[11].Value = model.F_AllowDelete;
			parameters[12].Value = model.F_SortCode;
			parameters[13].Value = model.F_DeleteMark;
			parameters[14].Value = model.F_EnabledMark;
			parameters[15].Value = model.F_Description;
			parameters[16].Value = model.F_CreatorTime;
			parameters[17].Value = model.F_CreatorUserId;
			parameters[18].Value = model.F_LastModifyTime;
			parameters[19].Value = model.F_LastModifyUserId;
			parameters[20].Value = model.F_DeleteTime;
			parameters[21].Value = model.F_DeleteUserId;
		...
		/// 得到一个对象实体
		/// </summary>
		public MyTest.Model.Sys_ModuleModel GetModel(string F_Id)
		{
			...
			MyTest.Model.Sys_ModuleModel model=new MyTest.Model.Sys_ModuleModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public MyTest.Model.Sys_ModuleModel DataRowToModel(DataRow row)
		{
			MyTest.Model.Sys_ModuleModel model=new MyTest.Model.Sys_ModuleModel();
			if (row != null)
			{
				...
				{
					if((row["F_IsMenu"].ToString()=="1")||(row["F_IsMenu"].ToString().ToLower()=="true"))
					{
						model.F_IsMenu=true;
					}
					else
					{
						model.F_IsMenu=false;
					}
				}
				if(row["F_IsExpand"]!=null && row["F_IsExpand"].ToString()!="")
				{
					if((row["F_IsExpand"].ToString()=="1")||(row["F_IsExpand"].ToString().ToLower()=="true"))
					{
						model.F_IsExpand=true;
					}
					else
					{
						model.F_IsExpand=false;
					}
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select F_Id,F_ParentId,F_Layers,F_EnCode,F_FullName,F_Icon,F_UrlAddress,F_Target,F_IsMenu,F_IsExpand,F_IsPublic,F_AllowEdit,F_AllowDelete,F_SortCode,F_DeleteMark,F_EnabledMark,F_Description,F_CreatorTime,F_CreatorUserId,F_LastModifyTime,F_LastModifyUserId,F_DeleteTime,F_DeleteUserId ");
